...
\usepackage{mathtools,amssymb,amsthm,pdfpages,listings,multicol}
...
\begin{enumerate}
	\item \textbf{Feltöltjük a firmware-t a szenzorra.} Erre azért van szükség, mert enélkül a szenzor csak egy hardveres érékelő, amely a lézerrel megvilágított felületről képeket készít. Ahhoz, hogy ezt az információt feldolgozza és továbbítsa szüksége van egy vezérlőprogramra, azaz firmware-re. A firmware feltöltését \aref{upload-firmware-code}. számú kód mutatja.
	...
	%%végén nem biztos hogy kell az ujraindítás és a laser cucc
\end{enumerate}
