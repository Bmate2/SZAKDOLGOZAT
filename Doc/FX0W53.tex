...
\end{lstlisting}
\section{Bikubik Interpoláció}
A bikubikus interpoláció egy képfeldolgozási technika, amit képek méretének változtatására használják. Lényege, hogy az új pixelek színét vagy színintenzitását a környező pixel értékek alapján számolja ki. Ez a módszer 4\,x\,4-es körzetben veszi figyelembe a színeket, ez azért jobb, mert több értéket vesz figyelembe így pontosabb színt kapunk az egyes pixelekhez.
\begin{lstlisting}[language=CSharp]
