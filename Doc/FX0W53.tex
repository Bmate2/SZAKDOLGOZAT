...
Az első kiegészítő függvény amit használtam az a \textbf{DisplayFrame} metódus aminek a segítségével megtudtam jeleníteni egy pictureboxba, hogy mit is lát a szenzor. Ennek annyi a lényege, hogy megkapja paraméterként a pixel intenzitásokat tartalmazó tömböt valamint a képmérethez szükséges adatokat. A bemeneti tömbön végig megyek és minden egyes pixelt elmentek egy Bitmap formátumú változóba. Mivel szürkeárnyalatos képet jelenítek meg ezért az RGB értékek helyére ugyanazt a színintenzitást rendelem. Végül a létrehozott Bitmap változót hozzárendelem a pictureboxhoz.
\begin{lstlisting}[language=CSharp]
...
\end{lstlisting}
Az egyik legfontosabb kiegészítő metódus a matrixToBitmap amiben egy mátrixot alakítok át egy Bitmap képpé.
\begin{lstlisting}[language=CSharp]
